      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-slate-100 p-10 md:p-14 rounded-[3rem] shadow-2xl border border-slate-300 relative overflow-hidden"
          >
            ...
            <form onSubmit={(e) => handleSubmit(e, 'standard')} className="relative z-10 space-y-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className={`w-full px-6 py-4 rounded-2xl border ${errors.name ? 'border-red-500 bg-red-50/10 text-red-900' : 'border-slate-300 bg-slate-200/80'} focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all text-sm font-bold placeholder:text-slate-400 shadow-sm`}
                  />
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-20 pr-6 py-4 rounded-2xl border ${errors.phone ? 'border-red-500 bg-red-50/10 text-red-900' : 'border-slate-300 bg-slate-200/50'} focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition-all text-sm font-black tracking-[0.1em] placeholder:text-slate-400`}
                    />
                  </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className={`w-full px-6 py-4 rounded-2xl border ${errors.email ? 'border-red-500 bg-red-50/10 text-red-900' : 'border-slate-300 bg-slate-200/50'} focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition-all text-sm font-bold placeholder:text-slate-400`}
                />
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select 
                    ...
                    className={`w-full px-6 py-4 rounded-2xl border ${errors.subject ? 'border-red-500 bg-red-50/10 text-red-900' : 'border-slate-300 bg-slate-200/50'} focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition-all text-sm font-bold appearance-none cursor-pointer placeholder:text-slate-400`}
                  >
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className={`w-full px-6 py-4 rounded-2xl border ${errors.message ? 'border-red-500 bg-red-50/10 text-red-900' : 'border-slate-300 bg-slate-200/50'} focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition-all text-sm font-bold resize-none placeholder:text-slate-400`}
                ></textarea>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                ...
                <motion.button
                  ...
                  className={`w-full py-5 rounded-2xl font-black uppercase tracking-[0.2em] text-[10px] flex items-center justify-center gap-3 shadow-lg transition-all ${
                    status === 'loading' ? 'bg-slate-300 text-slate-500' : 'bg-slate-100 text-slate-900 border-2 border-slate-200 hover:border-brand-500 hover:bg-slate-200'
                  }`}
                >
          ...
          <div className="space-y-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {[
                ...
                <motion.a
                  ...
                  href={item.href}
                  whileHover={{ y: -5 }}
                  className="bg-slate-100 p-8 rounded-[2rem] border border-slate-300 flex flex-col gap-6 group hover:border-blue-500 transition-all shadow-xl shadow-slate-300/20 relative overflow-hidden"
                >
            ...
            <div className="bg-slate-100 p-3 rounded-[3rem] shadow-2xl border border-slate-300 overflow-hidden aspect-video relative group">
               <iframe 
